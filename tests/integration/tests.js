...
describe('calculator ', function() {
  ...
  it(' - Must have the ability to handle various situations of numbers - positive, negative, decimal, vln', function(){
    running_total = element(by.css('#running_total'))
        ...
        element(by.css('#number9')).click();
        element(by.css('#operator_equals')).click();
        expect(running_total.getAttribute('value')).to.eventually.equal('-91')
...
element(by.css('#operator_multiply')).click();
        ...
        element(by.css('#operator_equals')).click();
        expect(running_total.getAttribute('value')).to.eventually.equal('-22750000000000000')
       
  })


  it('Should successfully report a division by 0 as being undefined', function(){
    element(by.css('#number4')).click();
    element(by.css('#operator_divide')).click();
         element(by.css('#number0')).click();
           element(by.css('#operator_equals')).click();
